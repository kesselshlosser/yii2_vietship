                                                                            ...
                                                                            <div class='col-md-6 col-sm-6 col-xs-12 form-chon-nv'>
                                                                                ...
                                                                                <div class='col-md-12 col-sm-12 col-xs-12 chon-nv-ca'>
                                                                                    ...
                                                                                    <div class="col-md-6" style="margin-top: 4px">
                                                                                        <input type="radio" name="ca<?= $model['id']?>" value="sang" <?= $totalCurrentMinute <= ((12*60) + 30) ? 'checked' : '' ?>/>
                                                                                        <label style="padding-top: 8px">Buổi sáng</label>
                                                                                    </div>
                                                                                    <div class="col-md-6" style="margin-top: 4px">
                                                                                        <input type="radio" name="ca<?= $model['id']?>" value="chieu" <?= $totalCurrentMinute > ((12*60) + 30) ? 'checked' : '' ?>/>
